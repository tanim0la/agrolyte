!(function(a) {
	...
	j.length > 0 &&
		j.magnificPopup({ type: 'inline', preloader: !0, removalDelay: 400, mainClass: 'mfp-fade bg-team-exp' });
	var L = a('.video-play');
	L.length > 0 &&
		L.magnificPopup({
			type: 'iframe',
	...
	var O = '../ico/images/',
		...
		R = '../ico-user/';
	i.hasClass('is-rtl') &&
		((O = '../../ico/images/'), (E = '../rtl/'), (R = '../../ico-user/'), (F = 'LTR Mode'), (M = '../index.html')),
		i.append(
			'<div class="demo-panel" hidden ><div class="demo-list"> <a class="demo-themes" title="See All Demo" href="javascript:void(0)"> <img src="' +
				O +
